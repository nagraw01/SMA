...
//                      starts the builder process pool and manages em// 
//                                                                    //
    ...
    public class MotherBuilder
    {
        ...
        public void receiveAction()
        {
            while (true)
            {
                ...
                {
                    getFiles(motherbuilderPath, "*.xml");

                    //enqueue all files in the blocking queue
                    Console.Write("\nEnqueuing all xml files on a file queue...\n----------------------------------------------------\n");
                    foreach (string file in files) requestFiles.enQ(file);
                }
